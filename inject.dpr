...
function HookProc(lpModuleName, lpProcName : PAnsiChar; NewProc : pointer; var OldProc : pointer) : boolean;
var
  hModule : dword;
  fnAdr : pointer;
begin
...
//begin//...//  dllPath:=  ExtractFilePath(GetCurrentModuleImagePath);//...//end.