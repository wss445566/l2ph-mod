...
begin
  ...
  try
    ...
    case action of
      ...
      TencDec_Action_ClearPacketLog :
      begin
      end; //данные нет. просто акшин; обработчик ClearPacketsLog
    //TSocketEngine вызывает эти
      ...
      begin
        ...
        begin
          ...
          begin
            if Loaded and Assigned(OnConnect) then
            begin
              OnConnect(Tunel.initserversocket, true);
            end;
          end;
        end;
      end;
      ...
      begin
        ...
        begin
          with TPlugin(Plugins.Items[i]) do
          begin
            if Loaded and Assigned(OnDisconnect) then
            begin
              OnDisconnect(Tunel.initserversocket, true);
            end;
          end;
        end;
      end;
      ...
      begin ////Создавать такие вещи в нити нельзя.. а вот тут можно...
        ...
        begin
          ...
          begin
            if Loaded and Assigned(OnConnect) then
            begin
              OnConnect(Tunel.initserversocket, false);
            end;
          end;
        end;
      end;
      ...
      begin
        ...
        begin
          ...
          begin
            if Loaded and Assigned(OnDisconnect) then
            begin
              OnDisconnect(Tunel.initserversocket, false);
            end;
          end;
        end;
      end;
...
begin
  ...
  if Pos(IntToStr(ntohs(msg.LParamLo)) + ';', sIgnorePorts + ';') <> 0 then
  begin
